...
instance Print BExp where
  prt i e = case e of
    BExpIdent id -> prPrec i 0 (concatD [prt 0 id])
...
instance Print IntExp where
  prt i e = case e of
    IntExpIdent id -> prPrec i 0 (concatD [prt 0 id])
...
instance Print Stmt where
  prt i e = case e of
    ...
    SBAss id bexp -> prPrec i 0 (concatD [prt 0 id, doc (showString ":="), prt 0 bexp])
    SIAss id intexp -> prPrec i 0 (concatD [prt 0 id, doc (showString ":="), prt 0 intexp])
    ...
    SBlock id type_ stmt -> prPrec i 0 (concatD [doc (showString "["), prt 0 id, doc (showString ":"), prt 0 type_, doc (showString "@"), prt 0 stmt, doc (showString "]")])
