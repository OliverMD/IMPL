...
BExp :: { BExp }
BExp : PIdent { AbsRules.BExpPIdent $1 }
...
BExp3 : '(' BExp ')' { $2 }
IntExp :: { IntExp }
IntExp : PIdent { AbsRules.IntExpPIdent $1 }
...
Stmt : 'SKIP' { AbsRules.SSkip }
     | PIdent ':=' BExp { AbsRules.SBAss $1 $3 }
     | PIdent ':=' IntExp { AbsRules.SIAss $1 $3 }
     ...
     | '[' PIdent ':' Type '@' Stmt ']' { AbsRules.SBlock $2 $4 $6 }
Type :: { Type }
